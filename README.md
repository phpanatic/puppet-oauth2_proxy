...
[oauth2_proxy](https://github.com/oauth2-proxy/oauth2_proxy) package and provides a
...
[`oauth2_proxy.cfg.example`](https://github.com/oauth2-proxy/oauth2-proxy/blob/master/contrib/oauth2-proxy.cfg.example)
